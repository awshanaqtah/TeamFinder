...
interface ProjectFinderProps {
  ...
  onBookmarkToggle?: (project: ProjectIdea) => void;
  projectsToCompare?: ProjectIdea[];
  onToggleCompare?: (project: ProjectIdea) => void;
  onAnalyzeGap?: (project: ProjectIdea) => void;
}
          ...
          <div className="space-y-4">
            ...
            {projectIdeas.map((idea, index) => (
              <ProjectCard
                ...
                isBookmarked={isBookmarked ? isBookmarked(idea.title) : false}
                onBookmarkToggle={onBookmarkToggle}
                isCompared={projectsToCompare ? projectsToCompare.some(p => p.title === idea.title) : false}
